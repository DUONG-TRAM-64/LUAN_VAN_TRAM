...
for n in range(1, 6): 
    ...
    with open(output_file, 'w', newline='') as fout:
        ...
        for model_name in model_list:
            ...
            filename = f"report_01_class_{model_name}_{n}_lay.csv"
            ...
            with open(filename, 'r', newline='') as fin:
                ...
                writer.writerow([model_name, filename] + reader[-1])  # Ghi dòng cuối-->viet them code , nối tất cả các file vừa tạo get_all.csv

# === Thêm đoạn này để nối tất cả các file get_pow*.csv thành get_all.csv ===

all_output_file = "get_all.csv"
header_written = False
...
print("Đã nối tất cả các file vào get_all.csv.")
